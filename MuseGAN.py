...
class MuseGAN():
    ...
    def _build_critic(self):
        ...
        x = self.conv(x, f=128, k=(1, 2, 1), s=(1, 2, 1), a='lrelu', p='same') #(1, 24, 1, 128)
        x = self.conv(x, f=256, k=(1, 12, 1), s=(1, 12, 1), a='lrelu', p='same') #(1, 2, 1, 256)
        x = self.conv(x, f=512, k=(1, 3, 1), s=(1, 2, 1), a='lrelu', p='same') #(1, 1, 1, 512)
    ...
    def sample_images(self, run_folder):
        ...
        np.save(os.path.join(run_folder, "sample_%d.npy" % self.epoch), gen_scores)
